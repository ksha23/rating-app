...
async function seedDiningHalls() {
  try {
    ...
    const review1 = new Review({ title: 'Review 1', stars: 4, review: 'Good food' });
    const review2 = new Review({ title: 'Review 2', stars: 5, review: 'Excellent service' });
    const review3 = new Review({ title: 'Review 3', stars: 4, review: 'Decent food' });
    const review4 = new Review({ title: 'Review 4', stars: 2, review: 'Terrible' });
    await review1.save();
    await review2.save();
    await review3.save();
    await review4.save();
    ...
    const diningHallsData = [
      {
        ...
        image: "https://d9mfr5qxp4i37.cloudfront.net/wp-content/uploads/sites/132/2019/06/2012-08-21-four-lakes-dining-stations-hubert-3-900x600.jpg",
      ...
      {
        name: "Liz's Market",
        image: "https://d9mfr5qxp4i37.cloudfront.net/wp-content/uploads/sites/132/2019/08/2016-11-03-lizs-market-1-1499x1000.jpg",
      ...
      },
      {
        ...
        image: "https://d9mfr5qxp4i37.cloudfront.net/wp-content/uploads/sites/132/2019/06/2012-09-05-gordon-interiors-10-900x600.jpg",
